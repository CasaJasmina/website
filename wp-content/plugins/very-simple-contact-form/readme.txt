...
Very Simple Contact Form uses the WP Dashboard language, set in Settings > General. 
...
Do not use multiple shortcodes on the same website. This may cause a conflict. 
...
3. Very Simple Contact Form widget (dashboard).